  ...
  const renderDesktopView = () => (
    <Card>
        <CardHeader className="flex flex-row items-center justify-between">
            <div>
                <CardTitle className="text-xl">Fournisseurs</CardTitle>
                <CardDescription>Ajoutez ou modifiez les fournisseurs.</CardDescription>
            </div>
    ...
    <div className="space-y-4">
        <div className="flex justify-between items-center flex-wrap gap-4">
            <div>
                ...
                <p className="text-muted-foreground">Ajoutez ou modifiez les fournisseurs.</p>
            </div>
            {canManage && <Button onClick={handleAddNewSupplier}>
                <PlusCircle className="mr-2 h-4 w-4" />
                Ajouter
