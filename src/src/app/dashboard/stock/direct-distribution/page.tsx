    ...
    const handleDistributionSubmit = async () => {
        ...
        if (!reason.trim()) {
            toast({
                ...
                description: "Veuillez indiquer la raison de cette distribution directe.",
                variant: "destructive",
            });
            return;
        }
        ...
        const distributionItems: DeliveryItem[] = Object.entries(distributionState)
            .map(([diaperId, value]) => {
                ...
                if (value.quantity > 0 && diaper) {
                    const quantityInPieces = value.mode === 'cartons' ? value.quantity * diaper.piecesPerCarton : value.quantity;
                    return {
                        diaperId,
        ...
        <div className="container mx-auto py-8 space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-2 pt-6 border-t">
                <div className="space-y-2 md:col-span-2">
                     <Label htmlFor="reason">Raison de la distribution</Label>
                     <Textarea
                        id="reason"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                {filteredDiapers.map((diaper) => {
                    ...
                    const totalPieces = itemState.mode === 'cartons' ? itemState.quantity * diaper.piecesPerCarton : itemState.quantity;
                        ...
                        <Card key={diaper.id} className="flex flex-col">
                            ...
                            <CardFooter className="p-3 mt-auto rounded-b-lg">
                                <div className="w-full">
                                    ...
                                    {itemState.quantity > 0 && itemState.mode === 'cartons' &&
            ...
            <div className="flex justify-end pt-8 mt-8 border-t">
                <Button size="lg" onClick={handleDistributionSubmit} disabled={isDistributionEmpty() || isSubmitting}>
